...
const TEMPERATURE_SERVICE_UUID = '19b10000e8f2537e4f6cd104768a1214';
...
noble.on('stateChange', (state) => {
    if (state === 'poweredOn') {
        ...
        noble.startScanning([TEMPERATURE_SERVICE_UUID], false);
    } else {
    ...
    if (peripheral.advertisement.localName === DEVICE_NAME) {
        ...
        peripheral.connect((error) => {
            ...
            peripheral.discoverSomeServicesAndCharacteristics([TEMPERATURE_SERVICE_UUID], [TEMPERATURE_CHARACTERISTIC_UUID], (error, services, characteristics) => {
                ...
                // Read the characteristic immediately after subscribing
